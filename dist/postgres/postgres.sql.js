export const UPDATE_DUE_TASKS_PICKED_SQL = (table) => `
  UPDATE ${table}
  SET picked = TRUE,
      picked_by = $2,
      last_heartbeat = NOW(),
  ...
  RETURNING
    ...
    ${table}.priority
`;
export const UPDATE_TASK_SUCCESS_SQL = (table) => `
  UPDATE ${table}
  ...
  WHERE task_name = $1
    ...
    AND picked_by = $4
`;
export const UPDATE_TASK_FAILURE_SQL = (table) => `
  UPDATE ${table}
  SET execution_time = $3,
      picked = FALSE,
      picked_by = NULL,
  ...
  WHERE task_name = $1
    ...
    AND picked_by = $4
`;
export const UPDATE_TASK_HEARTBEAT_SQL = (table) => `
  UPDATE ${table}
  ...
  WHERE task_name = $1
    ...
    AND picked_by = $3
`;
export const UPDATE_TIMED_OUT_EXECUTIONS_SQL = (table) => `
  UPDATE ${table}
  SET picked = FALSE,
      picked_by = NULL,
      last_heartbeat = NULL,
...
`;
export const DELETE_TASK_SQL = (tableName) => `
  DELETE FROM ${tableName}
  WHERE task_name = $1
    AND task_instance = $2
    AND picked_by = $3
`;
export const INSERT_TASK_IF_NOT_EXISTS_SQL = (tableName) => `
  INSERT INTO ${tableName} (task_name, task_instance, task_data, execution_time)
  VALUES ($1, $2, $3, $4)
  ON CONFLICT (task_name, task_instance) DO NOTHING
`;
export const UPDATE_TASK_SCHEDULE_SQL = (tableName) => `
  UPDATE ${tableName}
  SET execution_time = $3,
      task_data = $4,
      version = version + 1
